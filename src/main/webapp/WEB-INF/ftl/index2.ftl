...
<head>
	...
	<link rel="stylesheet" href="${base}/resources/css/fullcalendar.css" />
	<link rel="stylesheet" href="${base}/resources/css/jquery.gritter.css" />
...
<script src="${base}/resources/js/jquery.flot.min.js"></script> 
<script src="${base}/resources/js/jquery.flot.resize.min.js"></script> 
<script src="${base}/resources/js/jquery.peity.min.js"></script> 
<script src="${base}/resources/js/jquery.gritter.min.js"></script> 
<script src="${base}/resources/js/matrix.js"></script> 
<script src="${base}/resources/js/fullcalendar.min.js"></script> 
<script src="${base}/resources/js/matrix.calendar.js"></script> 
<script src="${base}/resources/js/matrix.chat.js"></script> 
<script src="${base}/resources/js/jquery.validate.js"></script> 
<script src="${base}/resources/js/matrix.form_validation.js"></script> 
<script src="${base}/resources/js/jquery.wizard.js"></script> 
<script src="${base}/resources/js/jquery.uniform.js"></script> 
<script src="${base}/resources/js/select2.min.js"></script> 
<script src="${base}/resources/js/matrix.popover.js"></script> 
<script src="${base}/resources/js/jquery.dataTables.min.js"></script> 
<script src="${base}/resources/js/matrix.tables.js"></script> 
<script src="${base}/resources/js/matrix.interface.js"></script> 
