...
<body>
        ...
        <ul class="nav">
            <li  class="dropdown" id="profile-messages" >
                ...
                <ul class="dropdown-menu">
                    <li><a class="menu_a" link="${base}/user/${user.id}/detail"><i class="icon-user"></i> 个人资料</a></li>
                    <li class="divider"></li>
    ...
    <!--sidebar-menu-->
    <!-- modify by jason 20171028 start  -->
    <!-- <div id="sidebar" style="OVERFLOW-Y: auto; OVERFLOW-X:hidden;"> -->
    <div id="sidebar">
    <!-- modify by jason 20171028 end  -->
        <ul>
            ...
            <li class="submenu"> 
                ...
                <ul>
                    <li><a class="menu_a" link="${base}/user/formcommon"><i class="icon icon-caret-right"></i>基本表单</a></li>
    ...
    <div id="content">
        ...
        <!--End-breadcrumbs-->
        <iframe src="${base}/index2" id="iframe-main" frameborder='0' style="width:100%;height: -webkit-fill-available;"></iframe>
    </div>
